...
import com.youbo.mapper.FriendMapper;
import com.youbo.mapper.SiteSettingMapper;
...
public class FriendServiceImpl implements FriendService
{
	...
	@Override
	public List<com.youbo.entity.Friend> getFriendList() {
		return friendMapper.getFriendList();
	}

	@Override
	public List<com.youbo.model.vo.Friend> getFriendVOList() {
	...
	@Transactional(rollbackFor = Exception.class)
	@Override
	public void saveFriend(com.youbo.entity.Friend friend) {
		friend.setViews(0);
