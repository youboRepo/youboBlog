...
import com.youbo.service.FriendService;
...
import com.youbo.util.HashUtils;
import com.youbo.util.IpAddressUtils;
import com.youbo.util.MailUtils;
import com.youbo.util.QQInfoUtils;
import com.youbo.util.StringUtils;
import com.youbo.util.comment.channel.ChannelFactory;
import com.youbo.util.comment.channel.CommentNotifyChannel;
...
public class CommentUtils {
	 ...
	 */
	public void judgeSendNotify(Comment comment, boolean isVisitorComment, com.youbo.entity.Comment parentComment) {
	 ...
	 * @param comment       当前收到的评论
	 */
	private void sendMailToParentComment(com.youbo.entity.Comment parentComment, Comment comment) {
