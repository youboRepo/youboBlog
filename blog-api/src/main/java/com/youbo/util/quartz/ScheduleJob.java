...
import com.youbo.service.ScheduleJobService;
import lombok.extern.slf4j.Slf4j;
import org.quartz.JobExecutionContext;
import org.springframework.scheduling.quartz.QuartzJobBean;
import com.youbo.util.common.SpringContextUtils;
...
public class ScheduleJob extends QuartzJobBean {
	...
	protected void executeInternal(JobExecutionContext context) {
		com.youbo.entity.ScheduleJob scheduleJob = (com.youbo.entity.ScheduleJob) context.getMergedJobDataMap().get(com.youbo.entity.ScheduleJob.JOB_PARAM_KEY);
		//获取spring bean
